...
An ML notebook on using Natural Language Processing technique on Amazon reviews to perfoerm sentiment analysis. The project is broken down in 3 parts. 

* Part 1: Basic exploratioon of the data, training a few models and testing performances of the models. Only uses 1000 reviews
